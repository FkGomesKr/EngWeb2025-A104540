export default function studentsListPage(slist, d){
    var pagHTML = `
    <!DOCTYPE html>
    <html>
        <head>
        ...
        <body>
            <div class="w3-card-4">
                ...
                <footer class="w3-container w3-purple">
                    <h5>Generated by Gomes in ${d} - [<a href="/alunos">Return</a>]</h5>
                </footer>
            ...
            <div class="w3-card-4">
                ...
                <form class="w3-container" method="POST">
                    <fieldset>
                        ...
                        <label>Name</label>
                        <input class="w3-input w3-round" type="text" name="nome" value="${a.name}"/>
                        <label>Git</label>
...
export function studentPage(aluno, d ){
    ...
    pagHTML +=     `</ul></div>
            <footer class="w3-container w3-teal">
                <address>Generated by Gomes in ${d} - [<a href="/alunos">Return</a>]</address>
            </footer>
        </div>
    </body>
    </html>
